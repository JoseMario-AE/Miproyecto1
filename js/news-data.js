const newsDatabase = {
    featured: [
        {
            ...
            content: `
                <img src="IMG/Imagen de WhatsApp 2025-09-26 a las 13.50.59_32e2a6d9.jpg" alt="Graduación 2025" class="img-fluid rounded my-3">
            ...
            `,
            image: "IMG/Imagen de WhatsApp 2025-09-26 a las 13.50.59_32e2a6d9.jpg",
    ...
    sports: [
        {
            id: 4,
            title: "Equipo de Fútbol Gana el Campeonato intercolegial",
            category: "DEPORTES",
            excerpt: "¡Orgullo del colegio! Nuestro equipo de fútbol se alzó con el trofeo tras una emocionante final contra el Colegio Juancito Pinto.",
            content: `
    ...
    events: [
        {
            id: 5,
            title: "Desfile civico de la Promocion 2025",
            category: "EVENTOS",
            excerpt: "La promocion de este año a superado todas las expectativas educativas, asi mismos, ellos tambien han podido superarse y no solo hablo en el ambito educativo.",
            content: `
                <img src="IMG/desfilecivico.jpg" alt="Feria de ciencias" class="img-fluid rounded my-3">
